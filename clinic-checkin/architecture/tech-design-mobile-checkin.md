...
**Related:** Epic [E2](../product/epics.md#e2-mobile-check-in), [US-007](../product/user-stories.md#us-007-pre-visit-check-in-from-personal-device), [US-008](../product/user-stories.md#us-008-receptionist-visibility-of-mobile-check-ins), PRD Mobile Check-In, [ADR-001](adrs.md#adr-001-websocket-with-polling-fallback-for-real-time-dashboard-updates)
