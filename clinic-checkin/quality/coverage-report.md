...
| [US-011](../product/user-stories.md#us-011-photo-capture-of-insurance-card) | Insurance card photo capture | [TC-801](test-suites.md#tc-801-photo-capture--happy-path-on-kiosk), [TC-802](test-suites.md#tc-802-photo-capture--ocr-failure), [TC-803](test-suites.md#tc-803-photo-capture--camera-permission-denied), [TC-804](test-suites.md#tc-804-photo-capture-on-mobile), [TC-805](test-suites.md#tc-805-insurance-card-photos-stored-and-accessible-to-staff) | 7/7 AC covered by TC-801..805 (last run: staging, 2024-03-10, all pass) | **Gap:** secondary insurance card photo capture not explicitly tested. Tracked: backlog. |
...
**Test case count:** 73 test cases across 12 suites.
