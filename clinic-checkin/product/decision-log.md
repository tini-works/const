...
**Traceability:**
- Traced from: Round 4 security incident — patient saw another patient's PHI on kiosk
- Matched by: [BUG-002](user-stories.md#bug-002-data-leak--previous-patients-data-visible-on-scan), [US-003](user-stories.md#us-003-secure-patient-identification-on-scan), [ADR-002](../architecture/adrs.md#adr-002-session-purge-protocol-for-kiosk-state-isolation)
- Confirmed by: Dr. Martinez (Medical Director), 2024-02-15
...
**Traceability:**
- Traced from: Round 6 state health board mandate — medication list confirmation required for license renewal
- Matched by: [US-005](user-stories.md#us-005-medication-list-confirmation-at-check-in), [E6](epics.md#e6-compliance--medication-list-at-check-in), [ADR-004](../architecture/adrs.md#adr-004-immutable-medication-confirmation-audit-records)
- Confirmed by: Dr. Martinez (Medical Director), 2024-03-01
...
**Traceability:**
- Traced from: Round 7 data loss incident — two receptionists editing Mrs. Rodriguez's record simultaneously
- Matched by: [BUG-003](user-stories.md#bug-003-concurrent-edit-causes-silent-data-loss), [US-004](user-stories.md#us-004-concurrent-edit-safety-for-patient-records), [ADR-003](../architecture/adrs.md#adr-003-optimistic-concurrency-control-via-version-field)
- Confirmed by: Alex Kim (Engineering), 2024-03-10
...
**Traceability:**
- Traced from: Round 3 patient request — wants to check in before arriving
- Matched by: [US-007](user-stories.md#us-007-pre-visit-check-in-from-personal-device), [US-008](user-stories.md#us-008-receptionist-visibility-of-mobile-check-ins), [E2](epics.md#e2-mobile-check-in), [PRD: Mobile Check-In](prd-mobile-checkin.md)
- Confirmed by: Sarah Chen (PM Lead), 2024-01-20
...
**Traceability:**
- Traced from: Round 5 — second clinic location opening, patients visit both
- Matched by: [US-009](user-stories.md#us-009-cross-location-patient-record-access), [US-010](user-stories.md#us-010-location-aware-check-in), [E3](epics.md#e3-multi-location-support), [ADR-005](../architecture/adrs.md#adr-005-centralized-database-for-multi-location-no-replication)
- Confirmed by: Alex Kim (Engineering), 2024-02-10
...
**Traceability:**
- Traced from: Round 10 Riverside acquisition — 4,000 patients with unknown overlap
- Matched by: [US-013](user-stories.md#us-013-duplicate-patient-detection-and-merge), [E5](epics.md#e5-riverside-practice-acquisition), [ADR-008](../architecture/adrs.md#adr-008-duplicate-detection-algorithm-for-riverside-migration)
- Confirmed by: Dr. Martinez (Medical Director), 2024-04-05
...
**Traceability:**
- Traced from: Round 9 performance crisis — Monday mornings, 30 concurrent check-ins causing kiosk freezes
- Matched by: [US-006](user-stories.md#us-006-peak-hour-check-in-performance), [ADR-007](../architecture/adrs.md#adr-007-scaling-strategy-for-50-concurrent-sessions), [TC-901](../quality/test-suites.md#tc-901-50-concurrent-kiosk-check-ins--response-time)
- Confirmed by: Alex Kim (Engineering), 2024-03-28
...
**Traceability:**
- Traced from: Round 10 Riverside acquisition — ~2,000 paper-only patient records
- Matched by: [US-012](user-stories.md#us-012-patient-data-migration-from-riverside), [E5](epics.md#e5-riverside-practice-acquisition), [ADR-009](../architecture/adrs.md#adr-009-object-storage-for-insurance-card-photos-and-scanned-records), [ADR-010](../architecture/adrs.md#adr-010-migration-pipeline-architecture--batch-import-with-rollback)
