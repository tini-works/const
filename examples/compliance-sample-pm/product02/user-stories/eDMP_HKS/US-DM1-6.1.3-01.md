...
1. **API Coverage**: The `EDMPApp.CreateDocument` endpoint encodes all Diabetes mellitus Typ 1 clinical data fields using the sciphox:sciphox-ssu observation structure when generating the XML document.
