...
1. **API Coverage**: The `EDMPApp.CreateDocument` endpoint produces eDMP Brustkrebs XML documents following the CDA levelone structure (clinical_document_header + body) when `DMPLabelingValue = "BRUSTKREBS"` is provided.
