## US-HKS-7.1.8-04 — Practice doctor must document Histopathologie anderer Hautkrebs as Ja or Nein in HKS-D documents

| Field | Value |
|-------|-------|
| **ID** | US-HKS-7.1.8-04 |
| **Traced from** | [HKS-7.1.8-04](../../compliances/raw/eDMP-HKS/eDMP-HKS/eHKS/HKS-7.1.8-04.md) |
