## US-DM1-6.1.5-05 — Practice doctor must document Pulsstatus as Nicht untersucht, Unauffaellig, or Auffaellig

| Field | Value |
|-------|-------|
| **ID** | US-DM1-6.1.5-05 |
| **Traced from** | [DM1-6.1.5-05](../../compliances/raw/eDMP-HKS/eDMP-HKS/Diabetes_m1_m2/DM1-6.1.5-05.md) |
...
1. Given an eDMP DM1 Anamnese is documented, when Pulsstatus is recorded, then exactly one of Nicht untersucht, Unauffaellig, or Auffaellig is selected
