## US-FORM1175 — The Vertragssoftware must provide a function to fill, print, and...

| Field | Value |
|-------|-------|
| **ID** | US-FORM1175 |
| **Traced from** | [FORM1175](../compliances/SV/FORM1175.md) |
| **Source** | AKA Q1-26-1 |
| **Status** | TBC |
| Matched by | — |
| Proven by | — |
...
As a practice staff (MFA), I want the Vertragssoftware provide a function to fill, print, and save the contract-specific 'Befundbogen entzuendliche Gelenkerkrankungen' form per AKA-Basisdatei rules as Volldruck, so that forms are generated correctly for submission.
