## US-DM2-6.1.5-12 — Practice doctor must document Spaetfolgen as multi-select (Nephropathie, Neuropathie, Retinopathie)

| Field | Value |
|-------|-------|
| **ID** | US-DM2-6.1.5-12 |
| **Traced from** | [DM2-6.1.5-12](../../compliances/raw/eDMP-HKS/eDMP-HKS/Diabetes_m1_m2/DM2-6.1.5-12.md) |
...
1. Given an eDMP DM2 Anamnese is documented, when Spaetfolgen is recorded, then one or more of Nephropathie, Neuropathie, or Retinopathie can be selected
