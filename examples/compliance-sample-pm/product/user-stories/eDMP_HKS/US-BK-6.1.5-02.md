## US-BK-6.1.5-02 — Practice doctor must document Receptor status (Oestrogenrezeptor, Progesteronrezeptor, HER2) in the Anamnese section

| Field | Value |
|-------|-------|
| **ID** | US-BK-6.1.5-02 |
| **Traced from** | [BK-6.1.5-02](../../compliances/raw/eDMP-HKS/eDMP-HKS/Brustkrebs/BK-6.1.5-02.md) |
