## US-HKS-7.1.8-06 — Practice doctor must document Histopathologie Aktinische Keratose as Ja or Nein in HKS-D documents

| Field | Value |
|-------|-------|
| **ID** | US-HKS-7.1.8-06 |
| **Traced from** | [HKS-7.1.8-06](../../compliances/raw/eDMP-HKS/eDMP-HKS/eHKS/HKS-7.1.8-06.md) |
