## US-HKS-6.1.3-01 — Practice doctor must document Gesamtbeurteilung Haut auffaellig as Ja or Nein in HKS-A documents

| Field | Value |
|-------|-------|
| **ID** | US-HKS-6.1.3-01 |
| **Traced from** | [HKS-6.1.3-01](../../compliances/raw/eDMP-HKS/eDMP-HKS/eHKS/HKS-6.1.3-01.md) |
