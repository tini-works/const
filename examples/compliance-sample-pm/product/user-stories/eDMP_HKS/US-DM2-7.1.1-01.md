## US-DM2-7.1.1-01 — Practice doctor must document Schwere Hypoglykaemien seit letzter Dokumentation as a count

| Field | Value |
|-------|-------|
| **ID** | US-DM2-7.1.1-01 |
| **Traced from** | [DM2-7.1.1-01](../../compliances/raw/eDMP-HKS/eDMP-HKS/Diabetes_m1_m2/DM2-7.1.1-01.md) |
...
1. Given an eDMP DM2 Verlauf section is documented, when Schwere Hypoglykaemien is recorded, then a non-negative integer count is stored
