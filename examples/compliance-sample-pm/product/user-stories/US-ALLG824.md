## US-ALLG824 — Change documentation must be maintained

| Field | Value |
|-------|-------|
| **ID** | US-ALLG824 |
| **Traced from** | [ALLG824](../compliances/SV/ALLG824.md) |
| **Source** | AKA Q1-26-1 |
| **Status** | TBC |
| Matched by | — |
| Proven by | — |
...
As a practice owner, I want change documentation is maintained, so that general compliance requirements are met.
