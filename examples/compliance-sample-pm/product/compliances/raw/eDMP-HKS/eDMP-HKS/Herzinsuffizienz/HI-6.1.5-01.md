## HI-6.1.5-01 — When a doctor documents eDMP HI anamnesis, Koerpergroesse, Koerpergewicht, Raucher, and Blutdruck must be captured
...
| **Matched by** | [US-HI-6.1.5-01](../../../../../user-stories/eDMP_HKS/US-HI-6.1.5-01.md) |

### Requirement

When a doctor documents eDMP HI anamnesis, Koerpergroesse, Koerpergewicht, Raucher, and Blutdruck must be captured
