## DM1-6.1.7-04 — Practice doctor must document HMG-CoA-Reduktase-Hemmer (Statin) status in the Medikamente section
...
| **Matched by** | [US-DM1-6.1.7-04](../../../../../user-stories/eDMP_HKS/US-DM1-6.1.7-04.md) |
