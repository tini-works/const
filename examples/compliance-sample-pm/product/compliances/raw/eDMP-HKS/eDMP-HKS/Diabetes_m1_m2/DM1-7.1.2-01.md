## DM1-7.1.2-01 — Practice doctor must document Empfohlene Schulung(en) wahrgenommen with nested Diabetes and Hypertonie sub-fields
...
| **Matched by** | [US-DM1-7.1.2-01](../../../../../user-stories/eDMP_HKS/US-DM1-7.1.2-01.md) |
