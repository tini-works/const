...
category: foundation
parent: c3-1
goal: Comprehensive billing for KV, GOA, BG, EDMP, and PVS export
summary: Multi-type healthcare billing with validation, submission, history tracking, and clearing center integration
c3-version: 4
---
...
Comprehensive billing suite supporting KV (statutory), GOA (private), BG (occupational), EDMP (DMP), and PVS export billing types, including validation, submission, and history tracking.
...
|------|------|------|
| IN | Patient/Schein data | c3-101 |
| IN | Contract validation | c3-105 |
| IN | Medical codes | c3-116 |
| IN | HPM billing APIs | c3-112 |
| OUT | Billing responses | c3-107 |
| OUT | Billing subsystems | c3-109 |
## Code References
