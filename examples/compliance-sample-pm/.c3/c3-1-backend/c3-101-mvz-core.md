---
id: c3-101
title: MVZ Core Service
type: component
category: foundation
parent: c3-1
goal: Primary backend service for medical practice management
summary: Handles patients, appointments, prescriptions, clinical documentation, and practice workflows
c3-version: 4
---
...
Primary backend service handling all medical practice management functionality including patient management, appointment scheduling, prescription handling, clinical documentation, and practice workflows. Located in `ares/app/mvz/`.
...
|------|------|------|
| Authentication context | c3-102 | IN |
| NATS messaging | c3-401 | IN |
| Framework services | c3-103 | IN |
| Patient data | c3-402 | OUT |
| File storage | c3-4 | OUT |
| Domain events | c3-115 | OUT |
## Code References
