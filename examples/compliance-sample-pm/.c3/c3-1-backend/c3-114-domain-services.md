---
id: c3-114
title: Domain Services Architecture
type: component
category: feature
parent: c3-1
goal: Domain-driven service organization with 57 domain boundaries
summary: Service layer in ares/service/domains/ providing clean separation between API and business logic
c3-version: 4
---
...
Organizes business logic by domain boundaries in ares/service/domains/ (57 domains), providing clean separation between application APIs and core domain logic with cross-domain service composition.
...
|-----------|------|---------|
| IN | Repository layer | c3-113 |
| IN | Titan framework | c3-103 |
| OUT | Domain APIs | c3-101 |
| OUT | Domain APIs | c3-104 |
