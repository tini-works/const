...
category: feature
parent: c3-1
goal: Generic type-safe MongoDB data access abstraction for all domains
summary: Base repository with CRUD, pagination, change streams, multi-tenancy for all domain repositories
c3-version: 4
---
...
Generic, type-safe abstraction over MongoDB providing CRUD, pagination, change streams, multi-tenancy, and the base for all domain-specific repositories.
...
|-----------|------|---------|
| IN | MongoDB driver | c3-402 |
| IN | DI framework | c3-103 |
| OUT | Base repository | c3-101 |
| OUT | Base repository | c3-104 |
| OUT | Change streams | c3-115 |
