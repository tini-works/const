...
category: foundation
parent: c3-1
goal: NATS-based RPC framework for all backend service communication
summary: In-house framework providing service routing, auth context propagation, middleware, and code generation integration
c3-version: 4
---
...
In-house NATS-based RPC framework providing service communication, request routing, authentication context propagation, middleware pipeline, and integration with GOFF code generation. Located in `ext/titan/`.
...
|------|------|------|
| IN | NATS connectivity | c3-401 |
| OUT | RPC framework | c3-101 |
| OUT | RPC framework | c3-102 |
| OUT | Client library | c3-301 |
| OUT | Client library | c3-302 |
## Code References
