---
id: c3-116
title: Medical Catalogs (Master Data)
type: component
category: feature
parent: c3-1
goal: German healthcare master data catalogs for codes, medications, and interactions
summary: SDKT, SDIK, SDEBM, GOA, SDOMIM catalogs from HIMI PostgreSQL cached in MongoDB
c3-version: 4
---
...
Provides access to German healthcare master data catalogs (SDKT, SDIK, SDEBM, GOA, SDOMIM) sourced from HIMI PostgreSQL and cached in MongoDB.
...
|-----------|------|---------|
| IN | HIMI PostgreSQL | c3-4 |
| IN | Repository layer | c3-113 |
| OUT | Medical codes | c3-104 |
| OUT | Drug data | c3-101 |
