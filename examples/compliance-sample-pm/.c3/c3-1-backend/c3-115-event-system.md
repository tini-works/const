...
category: feature
parent: c3-1
goal: Reliable event publishing using Outbox Pattern with MongoDB Change Streams
summary: Exactly-once event delivery via outbox collection, change streams, and NATS publishing
c3-version: 4
---
...
Reliable event publishing and consumption using the Outbox Pattern with MongoDB Change Streams, ensuring exactly-once delivery and enabling event-driven architecture.
...
|-----------|------|---------|
| IN | MongoDB outbox | c3-402 |
| IN | Repository layer | c3-113 |
| OUT | NATS events | c3-401 |
| OUT | WebSocket notifications | c3-404 |
