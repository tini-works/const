...
category: feature
parent: c3-1
goal: 'Full auth stack: OIDC PKCE, token introspection, RBAC, and data-level authorization'
summary: Zitadel OIDC with PKCE, encrypted cookies, token caching, role-based access, row-level MongoDB security
c3-version: 4
---
...
In-depth analysis of the full authentication and authorization stack: Zitadel OIDC with PKCE flow, encrypted session cookies, token introspection with caching, role-based access control, and row-level data authorization.
...
|-----------|------|---------|
| IN | OIDC tokens | c3-4 |
| IN | Security rules | c3-103 |
| OUT | Auth middleware | c3-101 |
| OUT | Data authorization | c3-113 |
