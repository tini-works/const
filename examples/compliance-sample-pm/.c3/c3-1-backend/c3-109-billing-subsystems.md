---
id: c3-109
title: Billing Subsystems
type: component
category: foundation
parent: c3-1
goal: 'Detailed billing subsystems: eDoku, patient billing, history, PADneXt, PVS export'
summary: Specialized billing subsystems for eDoku, patient statements, history, PADneXt XML, and PVS clearing
c3-version: 4
---
...
Detailed billing subsystems including eDoku billing, patient billing statements, billing history management, PADneXt XML export for private/BG billing, and PVS clearing center integration.
...
|-----------|------|---------|
| IN | Billing data | c3-104 |
| IN | Mail delivery | c3-107 |
| OUT | Export files | c3-4 |
| OUT | Clearing submissions | c3-4 |
