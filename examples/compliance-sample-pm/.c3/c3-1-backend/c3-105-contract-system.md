...
category: foundation
parent: c3-1
goal: Healthcare contract management (HZV/FAV) and patient enrollment
summary: Manages HZV, FAV, and standard KV contracts between practices and insurance providers
c3-version: 4
---
...
Manages healthcare contracts (HZV GP-centered care, FAV specialist care, standard KV) between practices and insurance providers, including patient enrollment and participation management.
...
|------|------|------|
| IN | HPM enrollment APIs | c3-112 |
| IN | Patient profiles | c3-101 |
| OUT | Contract validation | c3-104 |
| OUT | Enrollment status | c3-106 |
## Code References
