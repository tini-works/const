---
id: c3-112
title: HPM Integration
type: component
category: feature
parent: c3-1
goal: REST client integration with external HPM healthcare system
summary: 4 specialized API clients (HZV, AMM, EAV, Info) for enrollment, billing, medicine, and certificates
c3-version: 4
---
...
REST client integration with HPM (Hausarzt-Praxis-Manager), an external German healthcare system providing enrollment, billing submission, medicine management, and certificate validation.
...
| OUT | Enrollment APIs | c3-105 |
| OUT | Billing APIs | c3-104 |
| OUT | Medicine APIs | c3-116 |
