...
category: foundation
parent: c3-3
goal: Terminal-based practice management using Bubble Tea
summary: Keyboard-driven terminal UI with NATS/Titan backend connectivity and OIDC auth
c3-version: 4
---
...
Terminal-based Bubble Tea application for fast, keyboard-driven access to patient management and practice operations via direct NATS/Titan connectivity. Located in `ext/tui/`.
...
|------|------|------|
| c3-103 | IN | Titan client |
| c3-401 | IN | NATS connection |
| c3-102 | IN | OIDC auth |
| c3-101 | OUT | API calls |
## Code References
