---
id: c3-311
title: Companion TI Service
type: component
category: feature
parent: c3-3
goal: Telematik Infrastructure integration for health cards and digital signatures
summary: SOAP-based TI connector, card operations, Brainpool ECC certificates, PTV version support
c3-version: 4
---

# companion-ti-service
## Goal

Handles integration with German healthcare Telematik Infrastructure: SOAP-based connector communication, health card operations, digital signatures, Brainpool ECC certificate management, and PTV version support. Located in `ext/companion/internal/ti_service/`.
...
|------|------|------|
| IN | Companion core | c3-302 |
| IN | Titan/NATS | c3-103 |
| OUT | Card data | c3-101 |
| OUT | TI operations | c3-302 |
## Code References
