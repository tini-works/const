...
category: feature
parent: c3-3
goal: 'Additional integration capabilities: mail, Arriba, FTP, sessions, auto-update'
summary: POP3/SMTP email, Arriba cardiovascular risk, FTP/SFTP transfer, VPN, e-prescription, auto-update
c3-version: 4
---
...
Additional Companion integration capabilities: POP3/SMTP email handling, Arriba cardiovascular risk assessment, FTP/SFTP file transfer, Windows session management, WireGuard VPN, e-prescription handling, and auto-update system. Located in `ext/companion/internal/`.
...
|------|------|------|
| c3-302 | IN | Companion core |
| c3-401 | IN | NATS events |
| c3-107 | OUT | Mail operations |
| c3-4 | OUT | File transfers |
## Code References
