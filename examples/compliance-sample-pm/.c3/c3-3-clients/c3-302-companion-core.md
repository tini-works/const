---
id: c3-302
title: Companion Desktop Application
type: component
category: foundation
parent: c3-3
goal: Desktop app for local system integration and TI connectivity
summary: Go/Wails desktop app providing TI connector, card reading, gRPC server, and local operations
c3-version: 4
---
...
Desktop Go application (Wails) providing local system integration: TI (Telematik Infrastructure) connectivity, health card reading (eGK, HBA), gRPC server for web frontend, and local file operations. Located in `ext/companion/`.
...
|------|------|------|
| IN | Titan client | c3-103 |
| IN | NATS connection | c3-401 |
| IN | OIDC auth | c3-102 |
| OUT | TI operations | c3-311 |
| OUT | gRPC to web | c3-210 |
## Code References
