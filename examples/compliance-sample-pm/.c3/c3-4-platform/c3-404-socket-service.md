...
category: foundation
parent: c3-4
goal: WebSocket to NATS bridge for real-time bidirectional communication
summary: Manages WebSocket connections for common sessions, device pairing, and companion app communication
c3-version: 4
---
...
Go service managing WebSocket connections for real-time bidirectional communication including common sessions, device pairing, and companion app integration, with broadcasting capabilities. Located in `ares/proxy/socket/`.
...
|------|------|------|
| IN | WebSocket connections | c3-2 |
| IN | JWT validation | c3-102 |
| IN | Domain events | c3-115 |
| OUT | NATS messages | c3-401 |
| OUT | Real-time updates | c3-210 |
## Code References
