...
category: foundation
parent: c3-4
goal: Primary document database for all backend services
summary: Document-oriented storage for patients, appointments, prescriptions, billing, and system config
c3-version: 4
---
...
Primary document-oriented data store for patient records, appointments, prescriptions, billing, and system configuration across all backend services. Uses MongoDB v7.0+ with per-service databases.
...
|------|------|------|
| OUT | Data storage | c3-113 |
| OUT | Change streams | c3-115 |
| OUT | Session store | c3-102 |
## Code References
