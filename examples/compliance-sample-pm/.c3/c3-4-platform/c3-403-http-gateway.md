...
category: foundation
parent: c3-4
goal: Translates browser HTTP requests to NATS messages
summary: Go service handling JWT auth, request routing, CORS, and HTTP-to-NATS translation
c3-version: 4
---
...
Go service translating HTTP requests from web browsers into NATS messages, handling JWT authentication validation, request routing, CORS, and response mapping. Located in `ares/proxy/gateway/`.
...
|------|------|------|
| HTTP requests | c3-2 | IN |
| JWT validation | c3-102 | IN |
| NATS messages | c3-401 | OUT |
## Code References
