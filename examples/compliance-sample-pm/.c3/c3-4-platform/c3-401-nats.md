---
id: c3-401
title: NATS Messaging Infrastructure
type: component
category: foundation
parent: c3-4
goal: Messaging backbone for all service communication
summary: Request/reply RPC, pub/sub events, JetStream durable messaging
c3-version: 4
---
...
NATS messaging backbone providing request/reply RPC for synchronous calls, pub/sub for event broadcasting, and JetStream for durable messaging. Deployed via Docker Compose (dev) and Kubernetes (prod). Configuration in `hera/dev/docker-compose.yml`.
...
|------|------|------|
| OUT | Messaging | c3-103 |
| OUT | Messaging | c3-101 |
| OUT | Messaging | c3-403 |
| OUT | Messaging | c3-404 |
## Code References
