---
id: c3-210
title: MVZ Application
type: component
category: feature
parent: c3-2
goal: Primary medical practice management web application
summary: Next.js app with 51 feature modules for patients, billing, prescriptions, and clinical workflows
c3-version: 4
---
...
Primary medical practice management web application (app_mvz) built with Next.js 14, featuring 51 feature modules covering patient management, billing, prescriptions, communication, and clinical workflows. Located in `pkgs/app_mvz/`.
...
|-----------|------|---------|
| IN | UI components | c3-201 |
| IN | API types/hooks | c3-202 |
| IN | Utilities | c3-203 |
| IN | State management | c3-211 |
| OUT | User interface | c3-0 |
## Code References
