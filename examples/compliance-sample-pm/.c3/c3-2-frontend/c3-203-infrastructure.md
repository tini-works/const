...
category: foundation
parent: c3-2
goal: Shared utility library for all frontend applications
summary: React hooks, date/string/crypto utilities, web workers, WebSocket helpers, permission checking, i18n
c3-version: 4
---
...
Shared utility library (pvs-infrastructure) providing React hooks (9+), date/string/crypto utilities (14+ modules), web workers, WebSocket helpers, permission checking, and i18n support. Located in `pkgs/pvs-infrastructure/`.
...
|-----------|------|---------|
| IN | zod, moment, libsodium | c3-2 |
| OUT | Utilities | c3-210 |
| OUT | Hooks | c3-211 |
## Code References
