...
category: foundation
parent: c3-2
goal: Shared React component library for all frontend applications
summary: 53 component categories including forms, tables, Lexical editor, and TailwindCSS theming
c3-version: 4
---
...
Shared React component library (pvs-design-system) providing UI components, forms, tables, rich text editor (Lexical), and TailwindCSS theming used across all frontend applications. Located in `pkgs/pvs-design-system/`.
...
| IN | React 18 | c3-2 |
| IN | TailwindCSS | c3-2 |
| OUT | UI components | c3-210 |
| OUT | UI components | c3-2 |
## Code References
